# 1. Bucket para el Frontend (Sitio Web Estático)
resource "aws_s3_bucket" "frontend" {
  bucket = "carlos-ortiz-ai-agent-v2" # Nombre único para tu bucket
}
...
resource "aws_iam_role" "lambda_role" {
  name = "carlos-ortiz-ai-lambda-role"
